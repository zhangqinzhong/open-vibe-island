...
- **2026-04-08** 🎨 **v1.0.7** — 动画优化 & 文档重构。更顺滑的覆盖层过渡动画，贡献指南拆分，架构文档更新。(#185 #186 #187)

- **2026-04-08** ✅ **v1.0.6** — 审批 UI & 性能优化。动态审批按钮、审批状态修复、UI 性能提升。(#170 #177 #179)

- **2026-04-08** 🔌 **v1.0.5** — Hook 健康检查 & 多 Agent 支持。新增 **Qoder**、**Factory**、**CodeBuddy**（Claude Code 分叉）。Sparkle 自动更新。(#163 #165 #166)

- **2026-04-08** 🖥️ **v1.0.3** — Intel Mac 支持 & UX 优化。Badge 宽度修复，动画延迟降低，Dock 图标默认设置。(#145 #146 #147)

- **2026-04-08** 🔐 **v1.0.0** — 首个签名 & 公证版本。Apple 代码签名、公证、GitHub Actions 自动构建 DMG。

<details>
<summary>更早的动态 (4月5日–7日)</summary>

- **2026-04-07** 🌐 **v0.2.1** — SSH 远程支持。

- **2026-04-07** 🔏 **v0.2.0** — 代码签名基础设施。

- **2026-04-06** 🧩 **v0.1.9** — **OpenCode** 插件集成 & **iTerm2** 跳转支持。(#105 #107 #108)

- **2026-04-06** 🖱️ **v0.1.8** — Dock 图标开关。(#111)

- **2026-04-06** 🔄 **v0.1.6** — Sparkle 自动更新框架。
